...
@Component
@Slf4j
public class HHUAliOssUtils {
    private static final String ENDPOINT = "https://oss-cn-beijing.aliyuncs.com";
    private static final String BUCKETNAME = "hohaipan";
    private static final String REGION = "cn-beijing";

    public String uploadFile(String objectName, InputStream in) throws Exception {
        System.out.println("oss:开始上传文件");
        ...
        try {
            ...
            url = "https://" + BUCKETNAME + "." + "oss-" + REGION + ".aliyuncs.com" + "/" + objectName;
